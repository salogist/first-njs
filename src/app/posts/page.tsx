...
import PostImage from '@/app/components/PostImage'; // کامپوننت جدید را وارد می‌کنیم
              ...
              <div key={post.id} className="flex flex-col rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-1 transition-transform duration-300">
                <div className="flex-shrink-0">
                  <Link href={`/posts/${post.slug}`}>
                    {/* از کامپوننت جدید PostImage استفاده می‌کنیم */}
                    <PostImage
                      src={post.imageUrl}
                ...
                <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                  <div className="flex-1">
                    ...
                    <Link href={`/posts/${post.slug}`} className="block mt-2">
                      ...
                      {post.excerpt && <p className="mt-3 text-base text-gray-500">{post.excerpt}</p>}
                    </Link>
                  </div>
